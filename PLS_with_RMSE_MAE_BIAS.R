...
write.csv(CV1.out,  "PLS_CV1_metrics_each_iteration.csv",  row.names = FALSE)
write.csv(CV2.out,  "PLS_CV2_metrics_each_iteration.csv",  row.names = FALSE)
write.csv(CV0.out,  "PLS_CV0_metrics_each_iteration.csv",  row.names = FALSE)
write.csv(CV00.out, "PLS_CV00_metrics_each_iteration.csv", row.names = FALSE)

write.csv(summary_all, "PLS_all_CV_metrics_each_iteration.csv", row.names = FALSE)
...
write.csv(summary_mean, "PLS_summary_mean_cor_RMSE_MAE_Bias.csv", row.names = FALSE)
